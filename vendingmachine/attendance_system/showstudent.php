			  ...
			  if(isset($_GET['d_id']))
			  {
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <label for="exampleInputEmail1">Class : <?php  echo($row['class'])?></label><br>
                    <label for="exampleInputEmail1">ID : <?php  echo($row['id'])?></label><br>
                    <label for="exampleInputEmail1">Gender : <?php  echo($row['gender'])?></label><br>
                    <label for="exampleInputEmail1">Contect : <?php  echo($row['contect'])?></label><br>
             ...
             <div class="card-body">
               <table id="example1" class="table table-bordered table-striped">
				...
				if(isset($_GET['d_id']) and isset($_GET['date']))
				{
					$did = $_GET['d_id'];
					$date = $_GET['date'];	
					$sql = "select * from attendance where time between '$date 00:00:00' and '$date 23:59:00' and id = '$did'";
					//echo($sql);
					$result = $conn->query($sql);
					if ($result->num_rows > 0) {
					  $sno = 1;
